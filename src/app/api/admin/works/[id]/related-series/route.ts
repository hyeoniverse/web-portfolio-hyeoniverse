...
export async function GET(_request: Request, context: RouteContext) {
  ...
  if (relErr) return jsonServerError(relErr, "GET /api/admin/works/[id]/related-series");
...
export async function PUT(request: Request, context: RouteContext) {
  ...
  if (seriesIds.length > 0) {
    ...
    if (error) return jsonServerError(error, "PUT /api/admin/works/[id]/related-series");
  }
