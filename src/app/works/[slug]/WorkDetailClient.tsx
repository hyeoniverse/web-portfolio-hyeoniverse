...
export default function WorkDetailClient({
  ...
  return (
    ...
    <DetailLayout
      ...
      afterContent={
        <>
          ...
          {/* 이전/다음 프로젝트 — 위에 related posts 없으면 border-top (team 은 children 으로 이동) */}
          {(() => {
            const needsTopBorder = relatedPosts.length === 0;
            return (
              <AdjacentNav
                prev={prevProject ? {
    ...
    >
      ...
      {/* Team Members — children 끝 (gallery 다음) 에 표시 → 좋아요 버튼이 자연스럽게 다음에.
