...
export default function WebFlowSection() {
  ...
  const goToSection = useCallback(
    (index: number) => {
      ...
      const target = panels[index] as HTMLElement | undefined;
      if (!target) return;
            ...
            {designFeatures.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`${styles.featureFolderCard} ${isDark ? styles.featureFolderCardDark : ""}`}
                  >
        ...
        <div className={`${styles.panel} ${styles.panelWide}`}>
          ...
          <div className={styles.troubleGrid}>
            {troubleShootingItems.map((item, index) => (
              ...
              >
                <div className={styles.troubleItemHeader}>
