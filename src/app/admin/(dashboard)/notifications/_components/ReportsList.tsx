...
import { ExternalLink, Check, X } from "@/components/icons";
...
import type { Report, StatusFilter } from "../../reports/_types";
...
/** Notifications 페이지의 "신고" 탭 안에서 사용되는 신고 관리 컴포넌트.
 *  내부 상태 필터 (pending/resolved/dismissed/all) + 해결/기각/댓글 삭제 액션 포함.
 *  페이지 레벨 title/container 는 부모 (Notifications) 가 책임. */
