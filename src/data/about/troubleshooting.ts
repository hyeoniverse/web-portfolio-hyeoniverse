...
const rawTroubleShootingItems: TroubleShootingItem[] = [
  /* ── Backend / Admin ── */
  {
    ...
    cause: {
      ko: "처음에는 삭제 버튼을 누르면 해당 글이 **DB 에서 곧바로 사라지는** 구조로 만들어 두었습니다.\n\n작성 중이던 글을 실수로 지웠을 때 복구할 방법이 없으니, 결국 DB 콘솔에 직접 들어가 백업을 뒤져야 했습니다.\n\n관리자가 저 한 명뿐이라 \"내가 실수할 일이야 있겠나\" 라고 안이하게 생각했지만, **운영해 보니 버튼을 잘못 누르거나 여러 글을 한꺼번에 지우다 엉뚱한 글까지 함께 날리는 일이 생각보다 자주** 발생했습니다.",
