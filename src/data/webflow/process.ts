...
export const designProcess: ProcessStep[] = [
  {
    step: "01",
    title: { ko: "설계 및 디자인 시스템 구축", en: "Design System & Foundation" },
    description: {
  ...
  {
    step: "04",
    title: { ko: "다국어 지원 및 반응형 최적화", en: "Internationalization & Responsive Design" },
    description: {
  ...
  {
    step: "06",
    title: { ko: "문서화 및 프로젝트 회고", en: "Documentation & Project Retrospective" },
    description: {
