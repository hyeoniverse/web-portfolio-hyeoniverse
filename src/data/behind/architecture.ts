...
export const projectStructure: StructureItem[] = [
  ...
  { path: "behind/", description: { ko: "이 페이지 — 개발 과정 & 기술 문서", en: "This page — development process & technical docs" }, indent: 2 },
  ...
  { path: "data/", description: { ko: "정적 데이터 — projects, services, about, behind", en: "Static data — projects, services, about, behind" }, indent: 1 },
