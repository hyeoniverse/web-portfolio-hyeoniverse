...
export const designProcess: ProcessStep[] = [
  ...
  },
  {
    ...
    description: {
      ko: "기술 선택의 이유, 문제 해결 과정, 아키텍처 구조를 기록하는 **Behind 페이지**를 구현했습니다. Code Highlights, Troubleshooting, Architecture 시각화 등 **6개 패널**을 데스크톱 가로 스크롤과 모바일 세로 레이아웃으로 완성했습니다.",
      en: "Built the **Behind page** documenting technology choices, problem-solving processes, and architecture structure. Completed **6 panels** — Code Highlights, Troubleshooting, Architecture visualization, and more — desktop horizontal scroll and mobile vertical layout.",
    },
  },
];
