...
export async function translateWithProvider(
  ...
  switch (provider) {
    case "google": return translateWithGoogle(texts, sourceLang, targetLang);
    case "deepl":  return translateWithDeepL(texts, sourceLang, targetLang);
    case "claude": return translateWithClaude(texts, sourceLang, targetLang);
    default:       return translateWithGemini(texts, sourceLang, targetLang);
  }
}
...
export async function translateWithFallback(
  ...
  for (const provider of providerList) {
    try {
      const translations = await translateWithProvider(provider, texts, sourceLang, targetLang);
