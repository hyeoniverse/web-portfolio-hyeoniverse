...
> 개발하며 부딪힌 문제들의 원인과 해결 기록입니다. 각 항목은 문제 → 원인 → 해결 → 인사이트 순서로 정리했고, 개념적으로 중요한 10건을 앞에 두었습니다. 항목은 접어두었습니다.

## Top 10 — 중요한 개념을 담은 항목

<details>
<summary><strong>1. highlight.js 가 브라우저에서만 죽음 — 빌드·tsc·테스트는 전부 통과</strong></summary>
...
<details>
<summary><strong>2. 칩 hover 규칙 하나가 타이핑마다 6천 개 요소 스타일 재계산</strong></summary>
...
<details>
<summary><strong>3. LCP 이미지가 낮은 우선순위로 받히고, 스트리밍 경계가 공개를 300ms 미룸</strong></summary>
...
<details>
<summary><strong>4. 상세 페이지 전환 덮개가 걷힌 뒤에도 이전 페이지가 보임</strong></summary>
...
<details>
<summary><strong>5. 없는 주소의 404 화면에서 하이드레이션 불일치</strong></summary>
...
<details>
<summary><strong>6. 테마 전환 글로벌 transition이 컴포넌트 애니메이션을 덮어쓰기</strong></summary>
...
<details>
<summary><strong>7. Popover 내부 텍스트별 `mix-blend-mode: difference` 가 backdrop-filter 와 양립 불가</strong></summary>
...
<details>
<summary><strong>8. 작업물 순서를 바꾸면 저장 전인데 다른 작업물 순서까지 뒤섞임</strong></summary>
...
<details>
<summary><strong>9. 작업물을 전부 미발행으로 돌려도 목록에 데모 작업물이 나옴</strong></summary>
...
<details>
<summary><strong>10. 설치되지도 않는 Svelte 패키지 때문에 @vercel/analytics 설치가 실패</strong></summary>
...
<details>
<summary><strong>11. 언어 전환 시 로딩 화면 재출현</strong></summary>
...
<details>
<summary><strong>12. 자동저장 초기값 버그 — 수정 없이도 리비전 생성</strong></summary>
...
<details>
<summary><strong>13. 에디터 자동저장 — localStorage에서 DB 리비전으로의 진화</strong></summary>
...
<details>
<summary><strong>14. LoadingScreen이 SSR에 포함되지 않아 콘텐츠 flash 발생</strong></summary>
...
<details>
<summary><strong>15. dev 서버를 띄운 채 `npm run build` 하면 ChunkLoadError</strong></summary>
...
<details>
<summary><strong>16. 삭제된 댓글을 복구하려는데 내용이 이미 지워져 있던 문제</strong></summary>
...
<details>
<summary><strong>17. 자동저장이 기존 글 내용을 옛 버전으로 되돌림</strong></summary>
...
<details>
<summary><strong>18. 새 글 자동저장이 전부 500 (revisions.entity_id uuid)</strong></summary>
...
<details>
<summary><strong>19. 이메일 로그인 뒤 관리자 화면과 네비게이션이 로그인 상태를 모름</strong></summary>
...
<details>
<summary><strong>20. 오피스 문서 미리보기 iframe 이 "gview 다운로드 실패" 를 띄움</strong></summary>
...
<details>
<summary><strong>21. 기간으로 저장한 작업물 연도가 화면에 JSON 으로 노출</strong></summary>
...
<details>
<summary><strong>22. Lighthouse 성능 최적화 — reCAPTCHA 지연 로딩</strong></summary>
...
<details>
<summary><strong>23. Lighthouse 심화 성능 최적화 — 미사용 폰트 제거 및 리소스 경량화</strong></summary>
...
<details>
<summary><strong>24. 프로젝트 전체 성능 최적화</strong></summary>
...
<details>
<summary><strong>25. 이미지 원본 무압축 업로드 — 용량 초과 실패 + 네트워크 낭비</strong></summary>
...
<details>
<summary><strong>26. 언어 전환 시 레이아웃 시프트</strong></summary>
...
<details>
<summary><strong>27. About Backend 패널 — dbMobileList가 데스크톱에서 노출</strong></summary>
...
<details>
<summary><strong>28. CSS 토큰 미정의 — 11개 파일에서 참조하지만 선언 없음</strong></summary>
...
<details>
<summary><strong>29. CTA 버튼의 backdrop-filter 가 Chrome 에서 동작하지 않음</strong></summary>
...
<details>
<summary><strong>30. Portal 기반 드롭다운에서 CSS transition 이 걸리지 않음</strong></summary>
...
<details>
<summary><strong>31. mix-blend-mode: difference 안에서 자식 색을 개별 지정할 수 없음</strong></summary>
...
<details>
<summary><strong>32. Admin 테이블 모바일 가로 스크롤 시 row border 중간 끊김</strong></summary>
...
<details>
<summary><strong>33. Posts Bento — `grid-template-rows` 만으로는 카드별 높이 차이가 빈칸을 만듦</strong></summary>
...
<details>
<summary><strong>34. sticky filterBar IntersectionObserver — 인기글 사이드바와 1px 어긋남</strong></summary>
...
<details>
<summary><strong>35. float 이미지가 상세 페이지에서 텍스트와 딱 붙음 (간격 0)</strong></summary>
...
<details>
<summary><strong>36. EmojiPicker 를 inline→CSS 모듈로 바꾸니 hover/슬라이드 transition 이 안 먹음</strong></summary>
...
<details>
<summary><strong>37. ViewModeToggle 로 데스크톱에서 "모바일 모드" 가 무효</strong></summary>
...
<details>
<summary><strong>38. task list `:has()` — 과소 매칭과 과다 매칭 양쪽 함정</strong></summary>
...
<details>
<summary><strong>39. 전역 input reset 이 native 체크박스를 아예 안 그림</strong></summary>
...
<details>
<summary><strong>40. 테두리 있는 인라인 코드는 여러 줄로 줄바꿈되지 않는다</strong></summary>
...
<details>
<summary><strong>41. sticky 유리 헤더의 backdrop blur 가 안 걸리거나 옅음</strong></summary>
...
<details>
<summary><strong>42. 모바일에서 네비게이션 버튼이 로고 위에 겹침</strong></summary>
...
<details>
<summary><strong>43. 전역 strong 색이 본문에서 지정한 글자색을 덮음</strong></summary>
...
<details>
<summary><strong>44. Plate Editor 인라인 이미지 — 양옆에 커서 배치·텍스트 입력 불가</strong></summary>
...
<details>
<summary><strong>45. 열블록(Column) 스타일 round-trip 유실 — richtext↔markdown 변환 시 메타데이터 소실</strong></summary>
...
<details>
<summary><strong>46. 이미지 리사이즈 핸들 클릭 시 이미지가 삭제됨</strong></summary>
...
<details>
<summary><strong>47. 이미지 캡션 오버레이가 리사이즈 히트박스를 덮어 감지 불가</strong></summary>
...
<details>
<summary><strong>48. Tooltip auto placement — 스크롤 컨테이너 경계 미인식</strong></summary>
...
<details>
<summary><strong>49. 에디터 툴바 active 상태 — wrapper 블록 감지 실패</strong></summary>
...
<details>
<summary><strong>50. 각주 참조/내용 정합성 — 한쪽 삭제 시 고아 노드 잔존</strong></summary>
...
<details>
<summary><strong>51. 링크 클릭 시 즉시 이동 → 에디터에서 링크 편집 불가</strong></summary>
...
<details>
<summary><strong>52. Plate 인라인 코드에서 방향키 커서 점프</strong></summary>
...
<details>
<summary><strong>53. float 이미지 — 독립 블록 분리 + 빈 줄 가리기 + 빈 자리 커서·클릭 차단</strong></summary>
...
<details>
<summary><strong>54. 에디터 top bar 가 sticky 로 안 붙음 — `position: sticky` → `position: fixed` 전환</strong></summary>
...
<details>
<summary><strong>55. 에디터 폼 input 에서 한글 IME 입력이 깨짐</strong></summary>
...
<details>
<summary><strong>56. 블록 드래그가 HTML5 native drag 에 가로채여 pointer 드래그가 안 됨</strong></summary>
...
<details>
<summary><strong>57. IME 조합 중 첫 글자가 두 번 입력</strong></summary>
...
<details>
<summary><strong>58. 툴바 줄간격 Select 가 제목에선 빈칸 + 중복 key 경고</strong></summary>
...
<details>
<summary><strong>59. 서식을 지운 직후 Backspace 가 글자 대신 직전 편집을 되돌림</strong></summary>
...
<details>
<summary><strong>60. Richtext 게시물에서 코드 하이라이팅·줄바꿈 버튼이 사라짐</strong></summary>
...
<details>
<summary><strong>61. 마크다운 각주 번호 꼬임 — heading renderer와 marked-footnote 실행 순서 충돌</strong></summary>
...
<details>
<summary><strong>62. YouTube/Vimeo embed URL — watch URL이 iframe에서 로드 실패</strong></summary>
...
<details>
<summary><strong>63. 이미지 깨짐 placeholder — `dangerouslySetInnerHTML` 로 렌더된 markdown img 에는 React onError 가 안 붙음</strong></summary>
...
<details>
<summary><strong>64. 에디터 미리보기가 게시 상세와 레이아웃이 어긋남 — 공용 Article 뷰 컴포넌트로 추출</strong></summary>
...
<details>
<summary><strong>65. 댓글 마크다운 체크박스가 불릿으로만 렌더 — DOMPurify 가 URL 도 아닌 `type` 속성을 지움</strong></summary>
...
<details>
<summary><strong>66. 툴바 마크다운 삽입 — 빈 줄·블록 문법에서 의도한 요소가 안 나옴</strong></summary>
...
<details>
<summary><strong>67. Lenis Scroll Velocity 효과 미작동</strong></summary>
...
<details>
<summary><strong>68. Framer Motion transform과 CSS transform 충돌</strong></summary>
...
<details>
<summary><strong>69. GSAP ScrollTrigger 수평 무한 스크롤 구현</strong></summary>
...
<details>
<summary><strong>70. Works 가로 갤러리 양방향 무한 스크롤 래핑</strong></summary>
...
<details>
<summary><strong>71. GSAP ScrollTrigger가 breakpoint 변경 시 레이아웃 깨짐</strong></summary>
...
<details>
<summary><strong>72. About HeroPanel이 로딩 화면 뒤에서 미리 렌더링</strong></summary>
...
<details>
<summary><strong>73. 커스텀 커서 리사이즈 모드 — 마우스 방향에 따라 커서가 회전</strong></summary>
...
<details>
<summary><strong>74. About 페이지 첫 패널이 잘못된 위치에서 시작</strong></summary>
...
<details>
<summary><strong>75. Page transition 이 hold 단계에서 멈추고 morph 후 skeleton 노출</strong></summary>
...
<details>
<summary><strong>76. Series Deck — hover 펼침이 "사라졌다 나타나는" 듯한 느낌</strong></summary>
...
<details>
<summary><strong>77. Series Deck spread — `setPointerCapture` 가 자식 click 차단 + hit-area 공백으로 flicker</strong></summary>
...
<details>
<summary><strong>78. HTML5 drag 가 pointermove 를 막아 커스텀 커서가 멈추고 type 도 계속 바뀜</strong></summary>
...
<details>
<summary><strong>79. HTML5 D&D 의 quirks 회피 — chip 드래그 정렬을 pointer 기반으로 전환</strong></summary>
...
<details>
<summary><strong>80. HorizontalCarousel 안의 카드 클릭이 안 먹음 — `setPointerCapture` 가 자식 click 을 가로챔</strong></summary>
...
<details>
<summary><strong>81. Lenis 스무스 스크롤 환경에서 코드블록 위 세로 스크롤이 먹히던 문제</strong></summary>
...
<details>
<summary><strong>82. 가로 스크롤 구간에서 preventDefault 를 불러도 페이지가 세로로 밀림</strong></summary>
...
<details>
<summary><strong>83. 3D 원통의 판에서 가운데 클릭이 새 탭을 열지 않음</strong></summary>
...
<details>
<summary><strong>84. TypeScript useRef 타입 에러</strong></summary>
...
<details>
<summary><strong>85. reCAPTCHA 배지 z-index 문제</strong></summary>
...
<details>
<summary><strong>86. Navigation 메뉴가 좁은 viewport 에서 우측 actions 와 겹침 + indicator 가 resize 중 메뉴 위치를 못 따라감</strong></summary>
...
<details>
<summary><strong>87. EmojiPicker 에서 "two children with the same key: weather" 에러</strong></summary>
...
<details>
<summary><strong>88. 파비콘 기호가 설정한 글꼴과 다르게 그려짐</strong></summary>
